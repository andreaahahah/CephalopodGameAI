...
import playerExampleAlphaH as playerBmodule
...
class CephalopodGUI:
        ...
        for r in range(state.size):
            for c in range(state.size):
                ...
                if cell is None:
                    ...
                    # qui puoi vedere come prendere chi possiede una cella
                    player, pip = cell
    ...
    def show_game_over(self, message):
        ...
        if count_blue > count_red:
            ...
            winner_message = f"Vince Red con {count_red} celle contro {count_blue}"
        else:
        ...
        tk.Label(dialog, text=message, font=("Helvetica", 12), pady=10).pack()
        tk.Label(dialog, text=winner_message, font=("Helvetica", 12, "bold"), pady=10).pack()
